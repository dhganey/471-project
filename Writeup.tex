...
Defender=> assuming they only attack one vector, then we're going to average out to about -\textdollar~10000 anyway we play, no matter what the other variables are. The best resutls I found were defending 97 attacks. That way, the attacker will average out at -\textdollar~797.98 and the defender will average out at -\textdollar~9902.02.
\par
assuming:
attacker = 2
catk = 500
...
Defender=> The attacker's next best move is to attack 2 vectors. This time, the most cost effective way to ensure that he doesn't average out to make any money is to defend 68 vectors. This averages out to the defender losing \textdollar~41.43 and the attacker losing \textdollar~41.43 and the defender losing \textdollar~7758.77
\par
assuming:
attacker = 10
catk = 300
...
Defender=> This time the attacker attacks 10 vectors. The best response when the defender is paying \textdollar~300 per attack is to defend 22 vectors. This still gives a likelyhood of defense at 92.96\% and averages out the defender to lose \textdollar~2192.31 per round the defender to lose \textdollar~2907.69
\par
