...
Defender $\Rightarrow$ Assuming they only attack one vector, then the result is going to average out to about -\$10000 regardless of play style and the other variables. The best results found were defending 97 attacks. That way, the attacker will average out at -\$797.98 and the defender will average out at -\$9902.02.
\par
Assuming:
attacker = 2,
catk = 500
...
Defender $\Rightarrow$ The attacker's next best move is to attack 2 vectors. This time, the most cost effective way to ensure that s/he does not average out to gain any money is to defend 68 vectors. This averages out to the defender losing \$41.43 and the attacker losing \$41.43 and the defender losing \$7758.77
\par
Assuming:
attacker = 10,
catk = 300
...
\subsection{Conclusion}
Overall, the reasonable investment for the company entirely depends on the amount of attack vectors that the attacker decides to play. The fewer he plays, the more expensive it is for the company. CactusCard Credit must prioritize its defense resources based on the apparent attack ability of the opponent. Opponents who attack fewer vectors may in reality require a more significant defense effort.
